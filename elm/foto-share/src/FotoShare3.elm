module FotoShare3 exposing (main)
...
type alias Photo =
    { id : Id, url : String, desc : String, liked : Bool, comments : List String, newComment : String }


initialModel : Photo
initialModel =
    { id = 1, url = "https://programming-elm.com/1.jpg", desc = "Initial Photo", liked = False, comments = [ "Cowabunga!!" ], newComment = "" }
